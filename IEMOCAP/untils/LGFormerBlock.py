...
class DWFormerBlock(nn.Module):
    ...
    def mask_generation_function(self,haltingscore, x, mask,threshold=0.5, lambdas=0.85):
        ...
        # calculate data length  #one_mat shape: torch.Size([32, 324]), mask shape: torch.Size([32, 324])
        ...
        x4 = F.conv2d(x4, b, padding=(0, 1)).view(batch, -1)
        x4 = x4[:, :-1]
    ...
    def beforeDGWT(self,inputdata, mappingmask,attn1,lengths):#local_x,mappingmask,local_score,lengths
        '''
    ...
    def afterDGWT(self,inputdata1,inputdata2,attn1,attn2,mappingmask):#local_x,global_x,local_score,hh2,mappingmask
        '''
